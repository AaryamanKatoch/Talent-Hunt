...
export const checkForSpecialCharactersAndPunctuation = (
  string,
  variableName
) => {
  ...
  if (result) {
    throw new Error(`${variableName} contains special characters/punctuations`);
  }
  return string;
};

export const checkForNumbers = (string, variableName) => {
  ...
  if (result) {
    throw new Error(`${variableName} contains numbers`);
  }
  return string;
};
...
export const checkName = (string) => {
  ...
  if (a.length !== 2) {
    throw new Error(
      `The Name should be of format first_name <space> last_name`
    );
  }
  if (a[0].length < 3) {
    throw new Error(`The length of first_name should be more than 3`);
  }
  if (a[1].length < 3) {
    throw new Error(`The length of last_name should be more than 3`);
  }
  return string;
};
...
export const isValidMonth = (month) => {
  ...
  if (
    ...
    throw new Error(
      `Month should be in valid format i.e March/Mar or June/Jun`
    );
  }
};
