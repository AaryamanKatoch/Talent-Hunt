...
async function main() {
  ...
  let exp1 = {
    ...
    bulletPoints: [
      "Created an automation framework which tests the performance of scalability and reliability of ITSI Splunk application.",
      "Drove the development of a model-based automated testing framework for the Aurora database engine in an attempt to replace manually programmed tests in collaboration with the Aurora Storage team.",
      "The framework helped in identifying the weak performing features of the ITSI app, which after the fixes reduced 22% of data loss happening in previous version of the app.",
    ],
  ...
  let pro1 = {
    name: "Messaging App",
    description:
      "Created a secure real-time messaging platform where users can connect and share texts, images, videos and documents using websockets as the mode of communication. Used micro-services to manage each and every detail on UI. Used cryptographic algorithm to secure the messages exchanged between the users.",
  };

  let pro2 = {
    name: "Stay N Eat",
    description:
      "Created a secure, robust and resilient micro-service oriented platform for booking hotel rooms and ordering food. Implemented an asynchronous messaging queue for preparation and delivery of orders based on multiple parameters like preparation time, delivery time and customer type which increased the customer satisfaction by 25%.",
  };
  let pro = [pro1, pro2];
  ...
  console.log(jobseeker2._id, jobseeker2.email);
  try {
